...
Quando a regressão usa Forma Recente, o peso dela na projeção cai de **80%** (próxima rodada) para **50%** (daqui a 5) até o piso de **20%**, misturando com a forma geral.
...
7. **Regressão Completa com Limites (efeitos fixos)** — como a Completa, com Rodada Centrada ao Quadrado (Rodada − 19)
