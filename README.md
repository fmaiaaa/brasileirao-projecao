...
2. **Regressão linear + robusta:** `pts ~ rodada + rodada² + indicador_casa + rodada × indicador_casa + força adversário (média pts/jogo do oponente no intervalo) + turno + forma recente (últimos 5 jogos)`
